...
const ExpenseDocumentsSection = ({ expenseId }) => {
  const { attachments, loading, addAttachment, removeAttachment } =
    useAttachments(ATTACHMENT_OWNER_TYPE.EXPENSE, expenseId);
  ...
  return (
    <AppFormSection title="مدارک هزینه">
...
export default memo(ExpenseDocumentsSection);
