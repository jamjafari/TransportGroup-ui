...
const FuelRecordDocumentsSection = ({ fuelRecordId }) => {
  const { attachments, loading, addAttachment, removeAttachment } =
    useAttachments(ATTACHMENT_OWNER_TYPE.FUEL_RECORD, fuelRecordId);
  ...
  return (
    <AppFormSection title="مدارک سوختگیری">
...
export default memo(FuelRecordDocumentsSection);
