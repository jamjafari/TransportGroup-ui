...
const AccidentDocumentsSection = ({ accidentId }) => {
  const { attachments, loading, addAttachment, removeAttachment } =
    useAttachments(ATTACHMENT_OWNER_TYPE.ACCIDENT, accidentId);
  ...
  return (
    <AppFormSection title="مدارک تصادف">
...
export default memo(AccidentDocumentsSection);
