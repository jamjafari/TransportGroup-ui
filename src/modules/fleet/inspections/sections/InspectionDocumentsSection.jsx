...
const InspectionDocumentsSection = ({ inspectionId }) => {
  const { attachments, loading, addAttachment, removeAttachment } =
    useAttachments(ATTACHMENT_OWNER_TYPE.INSPECTION, inspectionId);
  ...
  return (
    <AppFormSection title="مدارک معاینه فنی">
...
export default memo(InspectionDocumentsSection);
